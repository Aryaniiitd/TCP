...
class StreamReassembler {
  private:
    ...
    size_t first_index;        //!< The index of the first unassembled byte
    size_t reassemble;        //!< The number of bytes in the substrings stored but not yet reassembled
  ...
  public:
    ...
    void push_substring(const std::string &data, const uint64_t index, const size_t eof);
